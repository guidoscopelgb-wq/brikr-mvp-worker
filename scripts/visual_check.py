...
with sync_playwright() as p:
    ...
    page.screenshot(path=str(artifacts / "brikr-landing-improved.png"), full_page=True)

    page.get_by_role("button", name="Comenzar gratis").click()
    page.get_by_label("Email").fill("demo@brikr.app")
    ...
    page.screenshot(path=str(artifacts / "brikr-dashboard-improved.png"), full_page=True)
    ...
    mobile.screenshot(path=str(artifacts / "brikr-mobile-improved.png"), full_page=True)
